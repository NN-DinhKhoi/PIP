...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.multiply xil_defaultlib.glbl -o multiply_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./multiply_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/GiaPhuc/ThietKeLuanLySo/Quoc/testPIP23_11/testPIP23_11.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key multiply_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc multiply_simv.daidir vcs_lib c.obj)
