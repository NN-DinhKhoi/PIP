...
#
# Script generated by Vivado on Wed Dec 11 19:34:09 +0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : multiply.sh
...
#
# Usage        : multiply.sh
#                multiply.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                multiply.sh [-reset_run]
#                multiply.sh [-reset_log]
#                multiply.sh [-help]
#
...
#                script (type 'multiply.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "multiply.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./multiply.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.multiply xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.multiply -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/GiaPhuc/ThietKeLuanLySo/Quoc/testPIP23_11/testPIP23_11.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log multiply_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./multiply.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: multiply.sh [-help]\n\
Usage: multiply.sh [-step]\n\
Usage: multiply.sh [-lib_map_path]\n\
Usage: multiply.sh [-reset_run]\n\
Usage: multiply.sh [-reset_log]\n\
Usage: multiply.sh [-keep_index]\n\
Usage: multiply.sh [-noclean_files]\n\n\
